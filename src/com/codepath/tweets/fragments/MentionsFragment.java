...
public class MentionsFragment extends TweetsListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		MyTwitterApp.getRestClient().getMentionsTimeline(0, true, new InitialHandler());
	...
	public void onRefreshHandler() {
		if(!loading) {
        	loading = true;
        	MyTwitterApp.getRestClient().getMentionsTimeline(firstTweet, true, new RefreshHandler());
        }
		else {
	...
	public void onScrollHandler(AbsListView view, int firstVisibleItem,
        ...
        if ((lastInScreen == totalItemCount) && !(loading) && !disableAutoRefresh) {
        	loading = true;
        	MyTwitterApp.getRestClient().getMentionsTimeline(lastTweet, false, new ScrollHandler());
        }
	}
}
